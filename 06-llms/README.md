...
- 🔗 [Unsloth](https://unsloth.ai/) — free desktop app for local fine-tuning, no code required. Supports 500+ models, LoRA and full fine-tune, 4-bit/16-bit. Shows live loss curves and GPU monitor. Exports directly to GGUF for Ollama and LM Studio.
...
- 💻 [Tutorial: Fine-tune Llama-3 and Use in Ollama](https://unsloth.ai/docs/get-started/fine-tuning-llms-guide/tutorial-how-to-finetune-llama-3-and-use-in-ollama)
...
- 📚 Optional: [Top AI Ethics and Policy Issues of 2025 and What to Expect in 2026](https://aihub.org/2026/03/04/top-ai-ethics-and-policy-issues-of-2025-and-what-to-expect-in-2026/)
